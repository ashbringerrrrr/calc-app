...
- На текущий момент чтобы не ставить mingw на рабочий linux, воюю с github actions и сборкой под win11 на github. На момент 19.03.2026 04:57 - безуспешно
## Используемый Стек
...
- CMake >= 3.16
- Qt 5.15+ (модули: Core, Gui, Quick, QuickControls2)
- Библиотека Boost
- Компилятор с поддержкой C++17
- Было проверено на OC Ubuntu24
